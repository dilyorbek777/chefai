            ...
            <div className="max-w-[1720px] max-[1100px]:px-12 mx-auto min-h-screen  px-16 py-25">
                ...
                <div className="grid grid-cols-5 max-md:flex max-md:flex-col-reverse  max-md: gap-4 mt-14 max-lg:px-0  max-md:grid-cols-1 w-full max-[1350px]:grid-cols-3 max-lg:grid-cols-2">
                    ...
                    <div className="flex flex-col gap-6 p-6 max-h-[500px] bg-white rounded-card w-full max-md">
                        ...
                        <Image src="/mini1.png" className='w-full rounded-card max-md:h-[300px] object-cover' alt="Hero" width={500} height={500} />
                    </div>

                    <Image src="/pic2.png" className='w-full max-[1350px]:hidden max-h-[500px] translate-y-20  object-cover rounded-card' alt="Hero" width={500} height={500} />
                    ...
                    <Image src="/pic1.png" className='w-full  max-h-[500px] object-cover rounded-card max-lg:hidden' alt="Hero" width={500} height={500} />
